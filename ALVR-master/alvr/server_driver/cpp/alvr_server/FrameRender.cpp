	...
	: m_pD3DRender(pD3DRender)
{
		...
		// fout.open("C:\\Users\\User\\Desktop\\tmp.txt",ios::out);
}
...
bool FrameRender::RenderFrame(ID3D11Texture2D *pTexture[][2], vr::VRTextureBounds_t bounds[][2], int layerCount, bool recentering, const std::string &message, const std::string& debugText, double upRatio, double downRatio)
{
	// Set render target
	m_pD3DRender->GetContext()->OMSetRenderTargets(1, m_pRenderTargetView.GetAddressOf(), m_pDepthStencilView.Get());
	...
	for (int i = 0; i < layerCount; i++) {
		...
		// float pic_ratio = 0.5*ratio;
		// ////////////////////////////////////
		double downPicRatio = 0.5*downRatio;
		double upPicRatio = 0.5*upRatio;
		// ////////////////////////////////////
		// float middle;
		// if(ratio<=0.81f)
		// {
		...
		//only shrink top and bottom
		{ DirectX::XMFLOAT3(-1, -downRatio, 0.5f), DirectX::XMFLOAT2(bound[0].uMin, 0.5+downPicRatio), 0 }, //downleft 
		{ DirectX::XMFLOAT3(0,  upRatio, 0.5f), DirectX::XMFLOAT2(bound[0].uMax, (0.5-upPicRatio)), 0 }, //upRight
		{ DirectX::XMFLOAT3(0, -downRatio, 0.5f), DirectX::XMFLOAT2(bound[0].uMax, 0.5+downPicRatio), 0 }, //downRight
		{ DirectX::XMFLOAT3(-1,  upRatio, 0.5f), DirectX::XMFLOAT2(bound[0].uMin, (0.5-upPicRatio)), 0 }, //upLeft
		
		
		// { DirectX::XMFLOAT3(-1.0f, -1.0f*downRatio, 0.5f), DirectX::XMFLOAT2(bound[0].uMin, bound[0].vMax-bound[0].vMax*downPicRatio ), 0 },
		// { DirectX::XMFLOAT3(0.0f,  1.0f*upRatio, 0.5f), DirectX::XMFLOAT2(bound[0].uMax, bound[0].vMin+bound[0].vMax*upPicRatio), 0 },
		// { DirectX::XMFLOAT3(0.0f, -1.0f*downRatio, 0.5f), DirectX::XMFLOAT2(bound[0].uMax, bound[0].vMax-bound[0].vMax*downPicRatio), 0 },
		// { DirectX::XMFLOAT3(-1.0f,  1.0f*upRatio, 0.5f), DirectX::XMFLOAT2(bound[0].uMin, bound[0].vMin+bound[0].vMax*upPicRatio), 0 },
		// // Right View original
		...
		{ DirectX::XMFLOAT3(0, -downRatio, 0.5f), DirectX::XMFLOAT2(bound[1].uMin, 0.5+downPicRatio), 1 },
		{ DirectX::XMFLOAT3(1,  upRatio, 0.5f), DirectX::XMFLOAT2(bound[1].uMax, 0.5-upPicRatio), 1 },
		{ DirectX::XMFLOAT3(1, -downRatio, 0.5f), DirectX::XMFLOAT2(bound[1].uMax,0.5+downPicRatio), 1 },
		{ DirectX::XMFLOAT3(0,  upRatio, 0.5f), DirectX::XMFLOAT2(bound[1].uMin, 0.5-upPicRatio), 1 },

		// { DirectX::XMFLOAT3(0.0f, -1.0f, depth), DirectX::XMFLOAT2(0.2, 0.8), 1 },
		// { DirectX::XMFLOAT3(1.0f,  1.0f, depth), DirectX::XMFLOAT2(0.8, 0.2), 1 },
		// { DirectX::XMFLOAT3(1.0f, -1.0f, depth), DirectX::XMFLOAT2(0.8, 0.8), 1 },
		// { DirectX::XMFLOAT3(0.0f,  1.0f, depth), DirectX::XMFLOAT2(0.2, 0.2), 1 },

		};
		// fout << "max: " << bound[0].vMax << ", min:"<< bound[0].vMin <<endl;
		
		SimpleVertex vertices_2[] =
		{
		// Left View

		// { DirectX::XMFLOAT3(-1.0f, -1.0f*downRatio, 0.5f), DirectX::XMFLOAT2(bound[0].uMin, bound[0].vMax-bound[0].vMin*downPicRatio ), 0 },
		// { DirectX::XMFLOAT3(0.0f,  1.0f*upRatio, 0.5f), DirectX::XMFLOAT2(bound[0].uMax, bound[0].vMin+bound[0].vMin*upPicRatio), 0 },
		// { DirectX::XMFLOAT3(0.0f, -1.0f*downRatio, 0.5f), DirectX::XMFLOAT2(bound[0].uMax, bound[0].vMax-bound[0].vMin*downPicRatio), 0 },
		// { DirectX::XMFLOAT3(-1.0f,  1.0f*upRatio, 0.5f), DirectX::XMFLOAT2(bound[0].uMin, bound[0].vMin+bound[0].vMin*upPicRatio), 0 },

		{ DirectX::XMFLOAT3(-1.0f, -downRatio, 0.5f), DirectX::XMFLOAT2(bound[0].uMin,  0.5-upPicRatio), 0 },
		{ DirectX::XMFLOAT3(0.0f,  upRatio, 0.5f), DirectX::XMFLOAT2(bound[0].uMax, 0.5+downPicRatio), 0 },
		{ DirectX::XMFLOAT3(0.0f, -downRatio, 0.5f), DirectX::XMFLOAT2(bound[0].uMax, 0.5-upPicRatio), 0 },
		{ DirectX::XMFLOAT3(-1.0f,  upRatio, 0.5f), DirectX::XMFLOAT2(bound[0].uMin, 0.5+downPicRatio), 0 },
		
		//only shrink top and bottom
		{ DirectX::XMFLOAT3(0, -downRatio, 0.5f), DirectX::XMFLOAT2(bound[1].uMin,0.5-upPicRatio ), 1 },
		{ DirectX::XMFLOAT3(1,  upRatio, 0.5f), DirectX::XMFLOAT2(bound[1].uMax, 0.5+downPicRatio), 1 },
		{ DirectX::XMFLOAT3(1, -downRatio, 0.5f), DirectX::XMFLOAT2(bound[1].uMax,0.5-upPicRatio ), 1 },
		{ DirectX::XMFLOAT3(0,  upRatio, 0.5f), DirectX::XMFLOAT2(bound[1].uMin,0.5+downPicRatio ), 1 },
		...
		// BYTE* tmp = reinterpret_cast<BYTE*>(mapped.pData);
		// fout << *tmp[0+4+0]<<endl;
		// for( UINT row = 0; row < srcDesc.Height; row++ )
		// {
		// 	UINT rowStart = row;
		// 	for( UINT col = 0; col < srcDesc.Width; col++ )
		// 	{
		// 		UINT colStart = col * 4;

		// 		int R = mapped.pdata[rowStart + colStart + 0]; // Red
		// 		int G = mapped.pdata[rowStart + colStart + 1]; // Green
		// 		int B = mapped.pdata[rowStart + colStart + 2];  // Blue
		// 		int A = mapped.pdata[rowStart + colStart + 3];  // Alpha
				
		// 	}
		// 	fout << endl;
		// }
		
		if(bound[0].vMax > bound[0].vMin)
		{
			memcpy(mapped.pData, vertices_1, sizeof(vertices_1));
		}
		
		else
		{
			memcpy(mapped.pData, vertices_2, sizeof(vertices_2));
		}
